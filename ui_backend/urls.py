...
from .controllers.Workflow.checkpoint import CheckPointRemoveHost, CheckPointAddHost
...
urlpatterns = [
    ...
    path('backend/workflow/checkpoint/add-host/', CheckPointAddHost.CheckPointAddHostController.as_view()),
