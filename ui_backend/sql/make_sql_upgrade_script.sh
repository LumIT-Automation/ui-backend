...
sqlSchemaFile=ui_backend/sql/${schema}.schema.sql
# db data file in the git repo.
sqlDataFile=ui_backend/sql/${schema}.data.sql
...
dbUser=uib
dbPassword=password
hostIp=$(grep -oP '[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}' $devSetupDir/vagrantfile-${api})
